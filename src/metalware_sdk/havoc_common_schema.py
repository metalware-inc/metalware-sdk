...
class Memory:
    ...
    def __init__(self, base_addr: int, size: int, memory_type: MemoryType, file: Optional[MemoryFile] = None, fill: Optional[int] = None, aliased_to: Optional[int] = None) -> None:
    ...
    def from_dict(obj: Any) -> 'Memory':
        ...
        size = from_int(obj.get("size"))
        return Memory(base_addr, size, memory_type, file, fill, aliased_to)
...
class MemoryLayout:
    ...
    def __init__(self, regions: List[Memory]) -> None:
        self.regions = regions

    @staticmethod
    def from_dict(obj: Any) -> 'MemoryLayout':
        assert isinstance(obj, dict)
        regions = from_list(Memory.from_dict, obj.get("regions"))
        return MemoryLayout(regions)

    def to_dict(self) -> dict:
        result: dict = {}
        result["regions"] = from_list(lambda x: to_class(Memory, x), self.regions)
        return result
...
class FormatMemoryLayoutRequest:
    ...
    def __init__(self, image_hash: str, memory_layout: MemoryLayout) -> None:
    ...
    def from_dict(obj: Any) -> 'FormatMemoryLayoutRequest':
        ...
        memory_layout = MemoryLayout.from_dict(obj.get("memory_layout"))
        return FormatMemoryLayoutRequest(image_hash, memory_layout)

    def to_dict(self) -> dict:
        result: dict = {}
        result["image_hash"] = from_str(self.image_hash)
        result["memory_layout"] = to_class(MemoryLayout, self.memory_layout)
        return result
...
class ImageConfig:
    ...
    def __init__(self, image_arch: ImageArch, image_format: ImageFormat, patches: List[Patch] = []) -> None:
    ...
    def from_dict(obj: Any) -> 'ImageConfig':
        ...
        return ImageConfig(image_arch, image_format, patches)
...
class MemoryConfig:
    ...
    def __init__(self, entry_address: Optional[int], memory_layout: List[Memory]) -> None:
        self.entry_address = entry_address
        self.memory_layout = memory_layout

    @staticmethod
    def from_dict(obj: Any) -> 'MemoryConfig':
        assert isinstance(obj, dict)
        ...
        return MemoryConfig(entry_address, memory_layout)
...
class ProjectConfig:
    ...
    #def __init__(self, fuzzer_config: Optional[FuzzerConfig], memory_config: MemoryConfig) -> None:
    def __init__(self, memory_config: MemoryConfig, fuzzer_config: Optional[FuzzerConfig] = None) -> None:
    ...
    def to_dict(self) -> dict:
        ...
        result["memory_config"] = to_class(MemoryConfig, self.memory_config)
        return result
...
class RunConfig:
    ...
    def __init__(self, dry_run: bool, image_name: str, fuzzer_config: Optional[FuzzerConfig]=None, instance_count: int=1) -> None:
    ...
    def from_dict(obj: Any) -> 'RunConfig':
        ...
        return RunConfig(dry_run, image_name, fuzzer_config, instance_count)
...
class HavocCommonSchema:
    ...
    def __init__(self, analysis_result: AnalysisResult, classified_crash: ClassifiedCrash, file_metadata: FileMetadata, format_memory_layout_request: FormatMemoryLayoutRequest, image: ImageConfig, memory_config: MemoryConfig, project_config: ProjectConfig, run_config: RunConfig, run_stats: RunStats, run_summary: RunSummary, trace_summary: TraceSummary, unclassified_crash: UnclassifiedCrash, upload_image_request: UploadImageRequest) -> None:
    ...
    def from_dict(obj: Any) -> 'HavocCommonSchema':
        ...
        return HavocCommonSchema(analysis_result, classified_crash, file_metadata, format_memory_layout_request, image, memory_config, project_config, run_config, run_stats, run_summary, trace_summary, unclassified_crash, upload_image_request)
