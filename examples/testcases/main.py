...
testcases: List[Testcase] = client.get_testcases(project_name=PROJECT_NAME, run_id=RUN_ID)
...
if len(testcases) > 0:
  ...
  input: TestcaseInput = client.get_testcase_input(project_name=PROJECT_NAME, run_id=RUN_ID, testcase_id=testcases[0].input_id)
  print(input)
